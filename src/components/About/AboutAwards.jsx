            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
                ...
                <motion.div {...fadeUp(0)} className="mb-24 max-w-4xl">
                    <div className="mb-6 flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            <span className="text-lg uppercase tracking-[0.3em] text-neutral-500">Accolades</span>
                        </div>
                    </div>
                    <h2
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {featuredAwards.map((award, i) => (
                        ...
                        >
                            ...
                            <p className="text-neutral-600 text-lg leading-7 mb-6">
                                {award.desc}
                            </p>
                ...
                <motion.div {...fadeUp(0.2)} className="mt-20 overflow-hidden rounded-[40px] bg-brand-primary p-10 text-white lg:p-14">
                    <div className="mb-6 flex items-center gap-4">
                        ...
                        <span className="text-lg uppercase tracking-[0.3em] text-brand-gold">Historical Milestones</span>
                    </div>
                    <h3
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-0 divide-y md:divide-y-0 border-t border-white/10">
                        {historicalAwards.map((item, i) => (
                            ...
                            >
                                ...
                                <div>
                                    <h5 className="text-lg uppercase tracking-wide text-white font-medium mb-1">
                                        {item.t}
                                    </h5>
                                    <p className="text-lg text-white/60 leading-relaxed">{item.d}</p>
                                </div>
                            </motion.div>
                        ))}
                    </div>
