        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          <motion.div {...fadeUp(0)} className="mb-6 flex items-center justify-center gap-4">
            ...
            <div className="flex items-center justify-center gap-2">
              <span className="text-lg uppercase tracking-[0.3em] font-semibold text-neutral-500">Vision & Mission</span>
            </div>
            <div className="h-px w-12 bg-brand-secondary" />
          </motion.div>
        ...
        >
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="mb-6 flex items-center justify-center gap-4">
              ...
              <span className="text-lg uppercase tracking-[0.3em] font-semibold text-brand-gold">Bio Foods Philosophy</span>
            </div>
            <h3
