    ...
    <LazyMotion features={domAnimation}>
      <section className="w-full bg-white text-neutral-950 overflow-hidden relative">
        ...
        <div className="border-b border-neutral-100 py-16 lg:py-24 relative overflow-hidden">
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[500px] h-[500px] text-brand-primary/[0.02] pointer-events-none select-none translate-x-1/4 hidden lg:block">
          ...
          <div className="space-y-24 lg:space-y-36">
            {allMembers.map((member) => (
              ...
              >
                ...
                {member.isFounder ? (
                  <div className="absolute right-0 bottom-0 w-80 h-80 text-brand-gold/[0.03] pointer-events-none select-none translate-x-12 translate-y-12 hidden xl:block">
                    {/* Abstract Sun/Growth organic ray mesh */}
                    <svg viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="0.35">
                  ...
                  member.index % 2 === 0 && (
                    <div className="absolute left-[-4%] top-[20%] w-64 h-64 text-brand-primary/[0.02] pointer-events-none select-none hidden xl:block">
