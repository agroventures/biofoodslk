      ...
      <section className="w-full bg-white text-neutral-950 overflow-hidden relative">
        ...
        <div className="border-b border-neutral-100 py-16 lg:py-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-16 relative z-10">
            <motion.span
              {...fadeUp(0)}
              className="flex items-center justify-center gap-3 mb-10 text-lg uppercase tracking-[0.3em] font-semibold text-neutral-500"
            >
              ...
              >
                ...
                <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start text-left relative z-10">
                  ...
                  <div className="w-full lg:col-span-7 pt-2">
                    <p className="text-lg uppercase tracking-[0.25em] text-brand-secondary font-semibold mb-2">
                      {member.role}
                    </p>
                    <h2
                            ...
                            {founderHighlights.map(
                              ({ icon: Icon, label, sub }) => (
                                ...
                                >
                                  ...
                                  <p
                                    className="text-lg text-neutral-900 leading-snug font-medium mb-1 text-center"
                                  >
                                    {label}
                                  </p>
