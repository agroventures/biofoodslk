                ...
                <motion.div {...fadeUp(0.2)} className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {values.map(({ icon: Icon, text }) => (
                    ...
                    >
                      ...
                      <span className="text-lg font-medium text-neutral-700 group-hover:text-neutral-900 transition-colors">{text}</span>
                    </div>
                  ))}
                </motion.div>
              </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              {stats.map((s, i) => (
                ...
                >
                  ...
                  <p className="text-lg uppercase tracking-[0.2em] font-semibold text-neutral-500 group-hover:text-white/80 transition-colors duration-300">
                    {s.label}
                  </p>
                </motion.div>
              ))}
        ...
        <section className="py-16 lg:py-24 bg-brand-primary relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            <div className="flex flex-col md:flex-row md:items-baseline justify-between border-b border-neutral-200 pb-6 mb-16">
              ...
              <motion.p {...fadeUp(0.05)} className="text-lg uppercase tracking-[0.3em] font-semibold text-brand-muted text-center md:text-left mt-2 md:mt-0">
