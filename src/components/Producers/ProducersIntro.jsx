    ...
    <div className="w-full bg-white text-neutral-950 overflow-hidden">
      ...
      <section className="py-28 lg:py-40 border-b border-neutral-100">
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          <motion.span
            {...fadeUp(0)}
            className="inline-flex items-center gap-3 mb-10 text-lg uppercase tracking-[0.35em] text-neutral-500"
          >
          ...
          <motion.div {...fadeUp(0.05)} className="flex flex-wrap gap-3 mb-12">
            <div className="inline-flex items-center gap-2 border border-neutral-200 px-4 py-2 hover:border-brand-primary transition-colors duration-300">
              ...
              <span className="text-lg uppercase tracking-[0.2em] text-neutral-700">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-end">
            ...
            <motion.div
              {...fadeUp(0.2)}
              className="space-y-5 text-neutral-600 text-lg leading-8"
            >
              <p>
      ...
      <section className="bg-brand-primary">
        <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            <p className="text-lg uppercase tracking-[0.2em] text-white/60 leading-6">
              Women&apos;s
              <br />
              Empowerment
            </p>
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-0 divide-x divide-neutral-200 border border-neutral-200">
            {regions.map((region, i) => (
              ...
              >
                ...
                <span className="text-lg font-medium uppercase tracking-[0.25em] text-neutral-700">
                  {region}
                </span>
              </motion.div>
            ))}
      ...
      <section className="py-28">
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          <div className="flex items-end justify-between mb-12">
            ...
            <motion.span
              {...fadeUp(0.1)}
              className="text-lg uppercase tracking-[0.35em] text-neutral-400"
            >
              #FacesOfMOPA
            </motion.span>
          </div>
