                ...
                <div className="grid lg:grid-cols-12 gap-0 shadow-xl">
                    ...
                    <div className="lg:col-span-4 relative">
                        ...
                        >
                            ...
                            <p className="text-lg uppercase tracking-[0.3em] text-brand-gold mb-8 relative">
                                Contact Information
                            </p>
                            ...
                            <div className="space-y-10 flex-1 relative">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-lg text-white mb-1">Phone</h3>
                                        <a href="tel:+94117487100" className="text-white/60 hover:text-brand-gold transition text-lg">
                                            +94 11 2201220
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-lg text-white mb-1">Email</h3>
                                        <a href="mailto:info@biofoodsagro.com" className="text-white/60 hover:text-brand-gold transition text-lg">
