          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
            <motion.div {...fadeUp(0)} className="mb-6 flex items-center justify-center gap-4">
              ...
              <div className="flex items-center gap-2">
                <span className="text-lg uppercase tracking-[0.3em] font-semibold text-neutral-500">Environmental &amp; Social</span>
              </div>
              <div className="h-px w-12 bg-brand-secondary" />
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
            ...
            <motion.div {...fadeUp(0)} className="mb-16 max-w-4xl mx-auto">
              <div className="mb-6 flex items-center justify-center gap-4">
                <div className="h-px w-12 bg-brand-secondary" />
                <div className="flex items-center gap-2">
                  <span className="text-lg uppercase tracking-[0.3em] font-semibold text-neutral-500">Environmental</span>
                </div>
                <div className="h-px w-12 bg-brand-secondary" />
              </div>
              <h2
                  ...
                  {environmental.map((item, index) => (
                    ...
                    >
                      ...
                      <div className="col-span-10">
                        ...
                        <p className="text-lg leading-7 text-neutral-600">{item.description}</p>
                      </div>
                    </motion.div>
                  ))}
                </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
            ...
            <motion.div {...fadeUp(0)} className="mb-16 max-w-7xl">
              <div className="mb-6 flex items-center justify-center gap-4">
                <div className="h-px w-12 bg-brand-secondary" />
                <div className="flex items-center gap-2">
                  <span className="text-lg uppercase tracking-[0.3em] font-semibold text-neutral-500">Social Impact</span>
                </div>
                <div className="h-px w-12 bg-brand-secondary" />
              </div>
              <h2
                ...
                {social.map((item, i) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-neutral-600 text-lg leading-7">{item.description}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
          ...
          <motion.div {...fadeUp(0)} className="bg-brand-primary py-20 lg:py-28">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
              <div className="mb-6 flex items-center justify-center gap-4">
                ...
                <span className="text-lg uppercase tracking-[0.3em] font-semibold text-brand-gold">Our Commitment</span>
                <div className="h-px w-12 bg-brand-gold" />
              </div>
              <h3
