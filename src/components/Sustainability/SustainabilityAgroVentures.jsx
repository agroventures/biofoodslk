          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
            <motion.div {...fadeUp(0)} className="mb-6 flex items-center justify-center gap-4">
              ...
              <div className="flex items-center gap-2">
                <span className="text-lg uppercase tracking-wide font-semibold text-neutral-500">Structured Excellence</span>
              </div>
              <div className="h-px w-12 bg-brand-secondary" />
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <motion.div {...fadeUp(0)} className="mb-16">
              <div className="mb-6 flex items-center justify-center gap-4">
                <div className="h-px w-12 bg-brand-secondary" />
                <div className="flex items-center gap-2">
                  <span className="text-lg uppercase tracking-[0.3em] font-semibold text-neutral-500">Governance</span>
                </div>
                <div className="h-px w-12 bg-brand-secondary" />
              </div>
              <h3
          ...
          <motion.div {...fadeUp(0)} className="bg-brand-primary py-16 lg:py-24">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
              <div className="mb-6 flex items-center justify-center gap-4">
                ...
                <span className="text-lg uppercase tracking-[0.3em] font-semibold text-brand-gold">ESG Philosophy</span>
                <div className="h-px w-12 bg-brand-gold" />
              </div>
              <h3
