...
const procedures = [
  {
    ...
    desc: "Prevention, detection and monitoring procedures implemented throughout every production stage.",
  },
  {
    icon: ClipboardCheck,
    title: "Quality Assurance",
    desc: "Continuous verification systems ensure compliance with international quality requirements.",
  },
  {
    icon: ShieldCheck,
    title: "Internal Control System",
    desc: "Comprehensive monitoring framework supporting organic and biodynamic integrity.",
  },
  {
    icon: Beaker,
    title: "Research & Development",
    desc: "Innovation-driven product development focused on quality, efficiency and sustainability.",
  },
];
...
const qaItems = [
  {
    ...
    description:
      "Comprehensive physical, chemical and microbiological testing procedures.",
  },
  {
    icon: BadgeCheck,
    title: "ISO Certified Operations",
    description:
      "International systems management across every processing facility.",
  },
  {
    icon: Shield,
    title: "HACCP Food Safety",
    description:
      "Critical control point monitoring at every stage of production.",
  },
  {
    icon: FileCheck,
    title: "Certification Verification",
    description:
      "Regular audits and third-party validation against international standards.",
  },
  {
    icon: Network,
    title: "Traceability Validation",
    description:
      "Complete product traceability from cultivation through export distribution.",
  },
  {
    icon: Award,
    title: "GMP Manufacturing",
    description:
      "Good Manufacturing Practice standards upheld across all facilities.",
  },
];
      ...
      <section className="w-full bg-white text-neutral-950">
        ...
        <div className="relative py-16 lg:py-24 border-b border-neutral-100 overflow-hidden">
          ...
          <div className="absolute top-0 right-0 w-80 h-80 text-brand-primary/4 pointer-events-none translate-x-1/4 -translate-y-1/4 select-none">
            ...
            >
              <path
                d="M45.3,-62.9C57.4,-53.8,65.1,-38.7,71.2,-22.4C77.4,-6.2,81.9,11.2,77.3,26.7C72.7,42.2,58.9,55.8,43.2,64.8C27.4,73.8,9.7,78.2,-7.9,76.5C-25.5,74.9,-43,67.2,-56,54.8C-69,42.4,-77.4,25.4,-79.1,7.5C-80.8,-10.4,-75.7,-29.2,-64.8,-42.6C-53.8,-56,-37,-64,-20.9,-69.1C-4.8,-74.2,10.6,-76.4,26.5,-74.6C42.4,-72.8,45.3,-62.9,45.3,-62.9Z"
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="flex flex-col items-center text-center gap-8">
              ...
              >
                ...
                safety, and sustainability throughout the value chain.
              </motion.p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-2 lg:grid-cols-4 divide-x divide-white/20">
            {STATS.map(({ value, label, icon: Icon }, i) => (
              <motion.div
                key={label}
                {...fadeUp(i * 0.08)}
                className="py-10 px-6 flex items-center justify-between gap-3"
              >
                <div>
                  <p
        ...
        <div className="border-b border-neutral-100">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
            <motion.div
              {...fadeUp(0)}
              className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-9 gap-px bg-neutral-200 border border-neutral-200"
            >
              {certifications.map((cert) => (
                <div
                  key={cert.id}
                  className="bg-white flex items-center justify-center py-6 px-4"
                >
                  <img
                    src={cert.img}
                    alt={cert.name}
        ...
        <div className="relative py-16 lg:py-20 border-b border-neutral-100 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="flex flex-col gap-16">
              {/* label */}
              <motion.div {...fadeUp(0)}>
                <span className="flex items-center justify-center gap-3 text-base font-semibold uppercase tracking-[0.35em] text-neutral-500 mb-6">
                  <span className="h-px w-10 bg-brand-secondary" />
                  Quality Framework
                  <span className="h-px w-10 bg-brand-secondary" />
                </span>
                <h3
                  className="text-4xl lg:text-5xl tracking-tight leading-snug text-center"
                  style={{
                    fontFamily: "Calibri, Gill Sans, Trebuchet MS, sans-serif",
                  }}
                >
                  Built on rigorous systems and continuous improvement.
                </h3>
              </motion.div>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {procedures.map(({ icon: Icon, title, desc }, i) => (
                  <motion.div
                    key={title}
                    {...fadeUp(i * 0.08)}
                    className="group flex flex-col items-center border border-neutral-200 bg-white p-8 shadow-[0_4px_24px_rgba(0,0,0,0.04)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_16px_48px_rgba(0,0,0,0.08)]"
                  >
                    ...
                    <h4
                      className="text-xl text-neutral-900 mb-3 text-center"
                      style={{
                        fontFamily:
                          "Calibri, Gill Sans, Trebuchet MS, sans-serif",
                      }}
                    ...
                    <p className="text-base leading-7 text-neutral-600 flex-1 text-center">
                      {desc}
                    </p>
        ...
        <div className="relative py-16 lg:py-24 bg-brand-light border-b border-neutral-200 overflow-hidden">
          ...
          <div className="absolute top-1/2 right-0 w-64 h-64 text-brand-secondary/5 pointer-events-none translate-x-1/3 -translate-y-1/2 select-none hidden lg:block">
            <svg
              viewBox="0 0 200 200"
              fill="currentColor"
              className="w-full h-full animate-[spin_160s_linear_infinite_reverse]"
            >
              <path
                d="M38.9,-56.5C50.3,-46.4,59.2,-34.2,64.8,-20C70.4,-5.8,72.8,10.4,68.2,24.2C63.6,38,51.9,49.4,38.4,57.2C24.9,65,9.6,69.2,-5.8,67.7C-21.3,66.2,-36.8,59,-48.4,48C-60,37,-67.8,22.2,-69.4,6.6C-71,-9,-66.4,-25.4,-57.2,-37.6C-48,-49.8,-34.2,-57.8,-20.2,-62C-6.2,-66.2,8,-66.6,20.4,-63C32.8,-59.4,27.5,-66.6,38.9,-56.5Z"
                transform="translate(100, 100)"
              />
            </svg>
          </div>
          <div className="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col items-center text-center gap-10">
            <motion.div {...fadeUp(0)}>
              <span className="inline-flex items-center gap-3 text-base font-semibold uppercase tracking-[0.35em] text-neutral-500 mb-8">
                <span className="h-px w-10 bg-brand-secondary" />
              ...
              >
                "What makes certified organic production fundamentally
                different?"
              </p>
            </motion.div>

            <motion.div {...fadeUp(0.15)}>
              <p className="text-base leading-8 text-neutral-600 text-center">
                ...
                Transparency, consumer confidence, and global market access -
                supporting sustainable farming and long-term ecosystem health.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="relative py-16 lg:py-24 border-b border-neutral-100 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="flex flex-col items-center text-center mb-16">
              <motion.div {...fadeUp(0)}>
                <span className="flex items-center justify-center gap-3 text-base uppercase font-semibold tracking-[0.35em] text-neutral-500 mb-6">
                  <span className="h-px w-10 bg-brand-secondary" />
                ...
                >
                  International standards recognised worldwide.
                </h3>
              </motion.div>

              <motion.p
                {...fadeUp(0.1)}
                className="mt-6 max-w-7xl text-base leading-7 text-neutral-500"
              >
                {certifications.length} active certifications spanning organic
                farming, food safety, fair trade, and international market
                access.
              </motion.p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {certifications.map((cert, i) => (
                <motion.div
                  key={cert.id}
                  {...fadeUp(i * 0.05)}
                  className="group flex flex-col items-center rounded-2xl border border-neutral-200 bg-white p-8 shadow-[0_4px_24px_rgba(0,0,0,0.04)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_16px_48px_rgba(0,0,0,0.08)]"
                >
                  ...
                  <h4
                    className="mb-3 text-xl tracking-tight text-neutral-950 text-center"
                    style={{
                      fontFamily:
                        "Calibri, Gill Sans, Trebuchet MS, sans-serif",
                    }}
                  ...
                  <p className="text-base leading-7 text-neutral-500 flex-1 text-center">
                    {cert.desc}
                  </p>
                  <div className="mt-6 h-px w-0 group-hover:w-10 bg-brand-secondary transition-all duration-500" />
                </motion.div>
        ...
        <div className="py-16 lg:py-20 border-b border-neutral-100">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <motion.div
              {...fadeUp(0)}
              className="flex flex-col items-center text-center mb-16"
            >
              <span className="inline-flex items-center gap-3 text-base font-semibold uppercase tracking-[0.35em] text-neutral-500 mb-6">
                <span className="h-px w-10 bg-brand-secondary" />
                Quality Assurance
                <span className="h-px w-10 bg-brand-secondary" />
              </span>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-0 divide-y md:divide-y-0 md:divide-x divide-neutral-200 border border-neutral-200">
              {qaItems.map(({ icon: Icon, title, description }, i) => (
                <motion.div
                  key={title}
                  {...fadeUp(i * 0.08)}
                  className="group w-full p-8 hover:bg-brand-light transition-colors duration-300 flex flex-col items-center text-center"
                >
                  ...
                  <p className="text-base leading-7 text-neutral-600 max-w-lg">
                    {description}
                  </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-end">
              ...
              >
                <p className="text-base leading-8 text-white/60">
                  ...
                  recognised standards - every product meets the expectations of
                  customers worldwide.
                </p>
                <div>
                  <a
