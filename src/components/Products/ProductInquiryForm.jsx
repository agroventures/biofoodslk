...
const ProductInquiryForm = () => {
  ...
  return (
    <section className="w-full border-t border-neutral-100 py-16 lg:py-24 relative overflow-hidden" style={{ background: "#F8F6F2" }}>
      {/* decorative blob */}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative">
        ...
        <div className="mb-16">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <span className="text-lg uppercase tracking-[0.3em] font-semibold text-neutral-500">Product Inquiry</span>
            <span className="w-8 h-px bg-brand-gold" />
          </div>
        ...
        <div className="grid lg:grid-cols-12 gap-0 shadow-xl">
          ...
          >
            ...
            <div className="relative">
              <p className="text-lg uppercase tracking-[0.3em] text-brand-gold mb-8">Why Choose Us</p>
