...
const ProductCard = ({ product }) => (
  ...
  >
    ...
    <div className="p-6">
      ...
      <p className="text-lg leading-6 text-neutral-500 line-clamp-2">{product.desc}</p>
      <span className="inline-block mt-4 text-lg uppercase tracking-[0.2em] text-brand-primary group-hover:underline">
        Explore Products
      </span>
    </div>
  </Link>
