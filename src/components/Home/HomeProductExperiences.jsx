      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mb-12 max-w-7xl">
          <div className="mb-6 flex items-center justify-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <span className="text-lg uppercase font-semibold tracking-wider text-neutral-500">
                Product Collection
              </span>
            </div>
            <div className="h-px w-12 bg-brand-secondary" />
          ...
          <p className="mt-8 max-w-7xl text-lg leading-8 text-neutral-600 text-center">
            A curated portfolio of organic products, responsibly sourced and
        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2">
          {products.slice(0, 4).map((product) => (
            <div key={product.slug} className="flex flex-col">
              ...
              <div className="mt-8">
                <h3
                  className="mt-4 text-4xl tracking-tight text-neutral-950 lg:text-5xl text-center"
                  style={{ fontFamily: "Calibri, Gill Sans, Trebuchet MS, sans-serif" }}
                >
                  {product.name}
                </h3>

                <p className="mt-6 text-lg text-center leading-8 text-neutral-600">
                  {product.desc}
                </p>
                ...
                <div className="mt-6 flex items-center justify-center">
                  <Link
                    ...
                    className="group mt-8 inline-flex items-center gap-3 rounded-full border border-brand-primary px-6 py-3 text-lg font-medium text-brand-primary transition-colors duration-300 hover:bg-brand-primary hover:text-white"
                  >
                    Explore Collection
        ...
        <div className="mt-28 rounded-[40px] bg-brand-primary p-10 text-white lg:p-14">
          ...
          <p className="mt-6 max-w-7xl text-lg leading-8 text-white/80 text-center">
            Transparent supply chains, international standards, and a commitment
            to sustainability.
          </p>
        </div>
      </div>
