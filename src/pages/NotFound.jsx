      ...
      <div className="min-h-screen bg-white text-neutral-950 antialiased flex flex-col">
        ...
        <main className="relative flex-1 flex items-center overflow-hidden">
          ...
          <div className="pointer-events-none absolute right-0 top-0 hidden select-none xl:block">
            <span className="text-[320px] font-black leading-none text-black/[0.03]">404</span>
          </div>

          {/* Organic blob — top left */}
          <div className="absolute top-0 left-0 w-80 h-80 text-brand-primary/[0.04] pointer-events-none -translate-x-1/4 -translate-y-1/4 select-none">
          ...
          <div className="absolute bottom-0 right-1/4 w-72 h-72 text-brand-gold/[0.05] pointer-events-none translate-y-1/4 select-none hidden lg:block">
